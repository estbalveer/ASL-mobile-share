...
class DirectCheckinScreen extends Component {
    ...
    async fetchCustomUploadField() {
        ...
        const customUploadField = await customFormService.getCustomUploadField(parsedUser.company_id, 'direct_check_in')
        this.setState({
            ...this.state,
            customUploadField
        })
            ...
            <View style={styles.container}>
                ...
                <KeyboardAwareScrollView contentContainerStyle={{ justifyContent: 'center', alignItems: 'center', alwaysBounceVertical: true }}
                    ...
                    <View style={styles.loginContainer}>
                        ...
                        <View>
                            <Text style={{ fontWeight: 'bold', fontSize: 30, marginBottom: 5, alignSelf: 'center' }}>Check In</Text>
                        </View>
                        ...
                        }
                        {
                            this.state.customUploadField?.enable && (
                                ...
                                <View>
                                    ...
                                    <Text style={{ alignSelf: 'center', fontSize: 12 }}>{ ((this.state.upload_picture_name).length > 10) ? 
...
export default connect(mapStateToProps, mapDispatchToProps)(DirectCheckinScreen);