...
class CheckoutScreen extends Component {
  ...
  getAllOutcome() {
    AsyncStorage.getItem('company_id').then((company_id) => {
      const body = {
        company_id,
      };
            ...
            <View style={styles.informationContainer}>
              <View style={styles.row}>
                ...
                <View style={styles.rowItem}>
                  ...
                  />
                  <Text style={{fontWeight: 'bold', fontSize: 16}}>
                    Klien: {this.state.client_info.client_entity_name}
                  </Text>
                </View>
              </View>
            </View>
                  ...
                  {this.state.isNote == true && (
                    <View style={styles.inputNote}>
                      <TextInput
                        ...
                        placeholder={'NOTE'}
                        onChangeText={(value) =>
                          this.setState({error: '', upload_notes: value})
                        }>
                        {this.state.note}
                      </TextInput>
                    </View>
